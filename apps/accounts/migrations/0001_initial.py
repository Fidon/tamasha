# Generated by Django 6.0.5 on 2026-05-18 19:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer_status', models.CharField(choices=[('NONE', 'None'), ('PENDING', 'Pending'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected')], default='NONE', max_length=10, verbose_name='organizer status')),
                ('theme_preference', models.CharField(choices=[('dark', 'Dark'), ('light', 'Light')], default='dark', max_length=5, verbose_name='theme preference')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='organizer_approvals', to=settings.AUTH_USER_MODEL, verbose_name='approved by')),
